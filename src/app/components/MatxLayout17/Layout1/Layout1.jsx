...
const Layout1 = () => {
  ...
  const verify_class = async (id) => {
    ...
    const result = await axios.post(
      'https://' + process.env.REACT_APP_BACKEND_URL + 'admin/update/status',
      {
        classroom_id: id,
        status: 1,
      },
  ...
  const update_credit = async (id) => {
    ...
    const result = await axios.post(
      'https://' + process.env.REACT_APP_BACKEND_URL + 'admin/update/price',
      {
        classroom_id: id,
        credit: price,
      },
  ...
  useEffect(async () => {
    ...
    const result = await axios.post(
      'https://' + process.env.REACT_APP_BACKEND_URL + 'admin/fetch/classroom',
      {},
      {
        headers: headers,
      }
