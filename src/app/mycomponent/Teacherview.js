...
const Teacherview = (props) => {
  const createmeeting = async () => {
    ...
    const result2 = await axios.post(
      'https://' + process.env.REACT_APP_BACKEND_URL + 'teacher/class/update',
      {
  ...
  const complete_response = async () => {
    ...
    const result = await axios.post(
      'https://' + process.env.REACT_APP_BACKEND_URL + 'teacher/class/complete/response',
      {
      ...
      {dis && (
        <div>
          ...
          <div className="inner-student-view">
            <p>TOPIC &emsp;&emsp;&emsp;&emsp;: {props.class_detail.topic}</p>
            <p>STUDENT&nbsp;&nbsp;&nbsp;&emsp;&emsp;:{props.class_detail.student_name}</p>
